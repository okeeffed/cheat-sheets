...
Second, we can use a GraphQL helper like `export default graphql(mutation)(SongCreate);` - however, when we wrap a mutation, it forms a mutate function as part of props.
